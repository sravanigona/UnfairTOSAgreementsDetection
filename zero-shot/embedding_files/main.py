...
from cp_database import setup_database, insert_document
...
def main():
    ...
    parser.add_argument('--test-db', action='store_true',
                        help='Test basic database connection')
    parser.add_argument('--test-full', action='store_true',
                        help='Test full database workflow')
    parser.add_argument('--analyze', type=str,
                        help='Text to analyze for anomalies')
